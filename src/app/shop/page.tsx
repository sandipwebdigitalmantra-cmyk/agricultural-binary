...
const html = `
    <section class="page-hero">
      <div class="container">
        ...
        <p>Browse the full Negila Sene catalogue — eco products, branded accessories and BA tools, all available with company-direct pricing.</p>
      </div>
    </section>
          ...
          <div class="catalog-products">
            <article class="product-card">
              ...
              <div class="product-img product-cap">
                ...
                <img class="product-photo" src="https://images.unsplash.com/photo-1586201375761-83865001e31c?w=500&h=500&fit=crop&q=80" alt="Basmati Rice 5kg" loading="lazy" onerror="this.onerror=null;this.src='https://placehold.co/500x500/2d7a2d/ffffff/png?text=Basmati';">
              </div>
            ...
            <article class="product-card">
              ...
              <div class="product-img product-sticker">
                <span class="discount-tag">-25%</span>
                <img class="product-photo" src="https://images.unsplash.com/photo-1599049482093-bf6e1ddc34dd?w=500&h=500&fit=crop&q=80" alt="Moong Daal 1kg" loading="lazy" onerror="this.onerror=null;this.src='https://placehold.co/500x500/2d7a2d/ffffff/png?text=Moong+Daal';">
              </div>
              <div class="product-info">
                <span class="product-category">Lentils</span>
            ...
            <article class="product-card">
              ...
              <div class="product-img product-cap">
                <span class="discount-tag">-22%</span>
                <img class="product-photo" src="https://images.unsplash.com/photo-1576092768241-dec231879fc3?w=500&h=500&fit=crop&q=80" alt="Darjeeling First Flush 250g" loading="lazy" onerror="this.onerror=null;this.src='https://placehold.co/500x500/2d7a2d/3d1e15/png?text=Darjeeling';">
              </div>
              <div class="product-info">
                <span class="product-category">Black Tea</span>
