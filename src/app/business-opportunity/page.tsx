...
// Business Opportunity | BA Income Plan | Negila Sene
...
const html = `
    <section class="page-hero">
      <div class="container">
        ...
        <h1>BA <span>Earning Structure</span></h1>
        <p>A transparent, three-stage income plan built for committed Brand Ambassadors.</p>
      </div>
    </section>
    ...
    <section class="section income-section" id="income">
      <div class="container">
        <div class="section-header">
          ...
          <h2>BA <span>Earning Structure</span></h2>
          <p>Displayed clearly for Brand Ambassador onboarding.</p>
        </div>
        <div class="income-grid">
          <article class="income-card"><b>01</b><h3>Activation Bonus</h3><p>Activation Bonus (2:1).</p></article>
          <article class="income-card"><b>02</b><h3>Repurchase Bonus</h3><p>Repurchase Bonus on 500 PV Left &amp; Right.</p></article>
          <article class="income-card"><b>03</b><h3>Monthly Commission</h3><p>Monthly Commission eligibility requires minimum 50 PV.</p></article>
        </div>
      </div>
    </section>
    ...
    <section class="section">
      <div class="container">
        <div class="section-header">
          ...
          <p>Simple, transparent conditions every BA must meet to remain active and earn from the plan.</p>
        </div>
        <div class="term-grid">
          <article>
            <strong>Active BA Status</strong>
            <p>Maintain a minimum of 50 PV in personal repurchase every calendar month to stay active.</p>
          </article>
          <article>
            <strong>Activation Bonus (2:1)</strong>
            <p>Sponsor at least one Left and one Right BA. The Activation Bonus is paid on every 2:1 matching pair built in your placement tree.</p>
          </article>
          <article>
            <strong>Repurchase Bonus</strong>
            <p>Repurchase Bonus is calculated on every 500 PV achieved on the Left leg and 500 PV on the Right leg. Carry-forward applies to unmatched volume.</p>
          </article>
          <article>
            <strong>Monthly Commission</strong>
            <p>Active BAs with minimum 50 PV qualify for the Monthly Commission pool, distributed on the 10th of every month.</p>
          </article>
          <article>
          ...
          <article>
            ...
            <p>BAs must follow the Negila Sene Code of Conduct. Misrepresentation of the income plan can result in deactivation.</p>
          </article>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="newsletter-box">
          ...
          <div class="newsletter-info">
            ...
            <h2>Ready to start? Register as a BA</h2>
