...
const html = `
    <section class="page-hero">
      <div class="container">
        ...
        <p>The binding terms that govern your use of the Negila Sene website, your Brand Ambassador membership, and every product purchase made through our network.</p>
      </div>
    </section>
    ...
    <section class="section legal-content-section">
      <div class="container">
        <article class="legal-doc">
          ...
          <p>By accessing the Negila Sene website, registering as a Brand Ambassador, or placing an order through any Stock Point, you agree to these Terms &amp; Conditions, our Privacy Policy, and the BA Code of Conduct. If you do not accept these terms, please do not use our services.</p>

          <h2>2. Eligibility</h2>
          <p>You must be at least 18 years old and a resident of India to register as a Brand Ambassador or purchase products. By accepting these terms you confirm that the information you provide is accurate and complete.</p>

          <h2>3. Account &amp; Brand Ambassador Registration</h2>
          <ul class="legal-doc-list">
            <li>Brand Ambassador registration is <strong>free</strong>; no joining fee or compulsory product purchase is required.</li>
            <li>You are responsible for keeping your login credentials confidential and for all activity under your account.</li>
            <li>Each user may hold only one active BA account at any time.</li>
          </ul>

          <h2>4. Products &amp; Pricing</h2>
          <p>All product descriptions, prices and availability are subject to change without prior notice. Eco produce and agricultural products may vary slightly in colour, weight or texture due to natural variation, which is not a manufacturing defect. Prices are inclusive of applicable GST unless stated otherwise.</p>
          ...
          <ul class="legal-doc-list">
            <li>Eco products and BA tools may be returned in original, saleable condition within <strong>30 days</strong> of delivery through your local Stock Point.</li>
          ...
          <h2>8. BA Income Plan</h2>
          <p>Brand Ambassadors earn through three components &mdash; the <strong>Activation Bonus (2:1)</strong> on every matching pair in the placement tree, a <strong>Repurchase Bonus</strong> on every 500 PV achieved on Left and Right legs, and a <strong>Monthly Commission</strong> for BAs maintaining a minimum of <strong>50 PV</strong> per month. All earnings are tied to genuine product sales; recruitment alone does not generate income. Detailed disclosures are available in the Income Disclosure document.</p>

          <h2>9. Code of Conduct</h2>
          <p>BAs must not make false income claims, charge upfront fees, misrepresent products, defame competitors or fellow members, or operate any pyramid-style scheme. Violations may lead to suspension or termination of your BA account.</p>
